...
## 15. 외부 AI 서비스 뱃지 UI 텍스트 다듬기 (2026-07-29)
- **작업 내용**: 프롬프트 박스 우단에 표시되는 대상 AI 식별 뱃지(badge)에서 불필요한 단어 제거.
- **주요 반영 사항**: `core/renderers/static_prompt.py` 내의 뱃지 렌더링 로직 수정 (`ChatGPT 전용` ➔ `ChatGPT` 등).
- **결과**: 정상 빌드 및 UI 간소화 완료.
