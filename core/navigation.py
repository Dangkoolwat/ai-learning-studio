...
EXPECTED_SECTIONS = (
    {   'description': '짧은 요청이 하나의 완성된 프롬프트로 발전하는 과정을 직접 체험해 보세요.',
        'id': 'ai-practice',
        'items': [   {   'description': '여름휴가 계획이라는 같은 주제를 여러 프롬프트 방식으로 바꾸며 최종 프롬프트를 완성합니다.',
                         'id': 'ai-practice-summer-vacation-basic',
                         'label': '여름휴가 계획 세우기 (프롬프트 기초편)',
    ...
    {   'description': '결과 품질을 높이는 한 줄 프롬프트 모음집',
        ...
        'items': [   {   'description': '한 줄 추가로 답변의 깊이와 품질 높이기',
                     ...
                     {   'description': '경험과 노하우를 연결해 강점을 찾고 반복 활용 가능한 자산으로 축적하기',
                         'id': 'prompt-snippets-experience-to-asset',
                         'label': '경험을 나만의 자산으로 바꾸기 ⭐',
                         'route': '/prompt-snippets/experience-to-asset/'}],
        'label': '프롬프트 한 스푼',
        'order': 2},
    ...
    {   'description': '프로젝트와 GPTs(GEM)를 활용해 작업별로 AI를 분리하고, 더 일관된 결과를 만들어 보세요.',
        'id': 'ai-assistant',
        'items': [   {   'description': '사실을 지어내지 않게 하고, 불확실하면 확인이 필요하다고 말하게 하는 짧은 지침 프롬프트입니다.',
        ...
        'label': '나만의 AI 만들기',
        'order': 4},
    {   'description': '이미지 프롬프트의 특징을 이해하고 원하는 이미지를 더 정확하게 만들어 보세요.',
        'id': 'image-ai',
        'items': [   {   'description': '원하는 문구를 입력해 마커로 그린 듯한 삐뚤빼뚤하고 귀여운 레터링 이미지를 만들어 보세요.',
                     ...
                     {   'description': '배경 사진은 그대로 두고, 사진 속 인물만 흰색 테두리가 있는 흑백 손그림 스티커처럼 바꿔보세요.',
                         'id': 'image-ai-sketch-sticker',
                         'label': '사진 속 인물만 손그림 스티커로 바꾸기',
                         'route': '/image-ai/sketch-sticker/'}],
        'label': '이미지 만들기',
        'order': 5},
)
