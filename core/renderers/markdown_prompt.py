...
EXCLUDED_HEADER_KEYWORDS = {
    ...
    "확정", "사용자 제공", "공식 확인", "미확정", "확인 필요",
    "AI 제안", "보류", "폐기", "자료 접근 불가",
}
...
def render_markdown_prompt_page(context: PageRendererContext) -> PageRendererResult:
    ...
    for prompt_block in prompt_blocks:
        ...
        body_html = escape_html(prompt_block.body)
