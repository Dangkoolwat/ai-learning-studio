...
EXPECTED_PAGES = (
    ...
    {'id': 'prompt-snippets-detect-biases', 'title': '내 판단이 한쪽으로 치우쳤는지 보기', 'description': '내 글이나 생각에 선입견이나 편향이 섞여 있는지 단정하지 않고 확인합니다.', 'route': '/prompt-snippets/detect-biases/', 'source': 'pages/sections/prompt-snippets/detect-biases.md', 'type': 'static-prompt', 'section': 'prompt-snippets', 'navigation': True, 'status': 'published', 'lang': 'ko', 'order': 25},
