...
EXPECTED_PAGES = (
    ...
    {'id': 'prompt-snippets-evaluate-tradeoff', 'title': '선택하면 무엇을 포기하는지 보기', 'description': '선택으로 얻는 것뿐만 아니라 대신 포기해야 하는 가치와 대가를 함께 비교합니다.', 'route': '/prompt-snippets/evaluate-tradeoff/', 'source': 'pages/sections/prompt-snippets/evaluate-tradeoff.md', 'type': 'static-prompt', 'section': 'prompt-snippets', 'navigation': True, 'status': 'published', 'lang': 'ko', 'order': 24},
    {'id': 'prompt-snippets-detect-biases', 'title': '내 판단이 한쪽으로 치우쳤는지 보기', 'description': '내 글이나 생각에 판단에 영향을 준 선입견이나 편향이 섞여 있는지 단정 없이 확인합니다.', 'route': '/prompt-snippets/detect-biases/', 'source': 'pages/sections/prompt-snippets/detect-biases.md', 'type': 'static-prompt', 'section': 'prompt-snippets', 'navigation': True, 'status': 'published', 'lang': 'ko', 'order': 25},
    ...
    {'id': 'ready-to-use-korean-editor', 'title': '맞춤형 한국어 교정', 'description': '원하는 용도와 말투를 선택해 빠르고 자연스럽게 글을 다듬어 보세요.', 'route': '/ready-to-use/korean-editor/', 'source': 'pages/sections/ready-to-use/korean-editor.md', 'type': 'static-prompt', 'section': 'ready-to-use', 'order': 27, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'ready-to-use-universal-handoff', 'title': 'AI 작업 이어가기', 'description': '긴 대화를 작업 인계서로 변환하여 어느 AI에서든 끊김 없이 이어서 작업할 수 있게 만드는 범용 프롬프트', 'route': '/ready-to-use/universal-handoff/', 'source': 'pages/sections/ready-to-use/universal-handoff.md', 'type': 'static-prompt', 'section': 'ready-to-use', 'order': 29, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'ai-assistant-gemini-verifier', 'title': 'Gemini 지식 검증', 'description': 'Gemini GEMs 및 Projects 전용 지식 검증 전문가(Knowledge Verification Expert) 지침 프롬프트입니다.', 'route': '/ai-assistant/gemini-verifier/', 'source': 'pages/sections/ai-assistant/gemini-verifier.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 33, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    {'id': 'ai-assistant-vacation-planner', 'title': '맞춤형 여행 플래너', 'description': '실습에 바로 활용하는 국내외 맞춤형 여행 플래너 GEM·Project 전용 지침 프롬프트입니다.', 'route': '/ai-assistant/vacation-planner-guide/', 'source': 'pages/sections/ai-assistant/vacation-planner-guide.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 34, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    {'id': 'ai-assistant-gemini-canvas-map', 'title': 'Gemini 캔버스 대화형 여행 지도', 'description': 'Gemini Canvas를 활용해 웹 브라우저에서 바로 작동하는 단일 HTML Leaflet 대화형 여행 지도를 만드는 프롬프트입니다.', 'route': '/ai-assistant/gemini-canvas-map/', 'source': 'pages/sections/ai-assistant/gemini-canvas-map.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 35, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    {'id': 'ai-assistant-korean-editor', 'title': '자연스러운 한국어 다듬기 지침서', 'description': '실습에 바로 활용하는 자연스러운 한국어 전문 편집자 GEM·Project 전용 지침 프롬프트입니다.', 'route': '/ai-assistant/korean-editor-guide/', 'source': 'pages/sections/ai-assistant/korean-editor-guide.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 36, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'ai-assistant-self-development-coach', 'title': '현실적인 자기계발 코치', 'description': '목표를 실천 가능한 작은 단위로 나누고, 무리하지 않게 지속할 수 있도록 돕는 1:1 맞춤형 코치 시스템 프롬프트입니다.', 'route': '/ai-assistant/self-development-coach/', 'source': 'pages/sections/ai-assistant/self-development-coach.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 38, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'image-ai-resume-profile', 'title': 'AI 이력서·프로필 사진 생성', 'description': '내 사진을 기반으로 다양한 의상과 구도의 전문적인 프로필 사진을 제작해 보세요.', 'route': '/image-ai/resume-profile/', 'source': 'pages/sections/image-ai/resume-profile.md', 'type': 'static-prompt', 'section': 'image-ai', 'order': 45, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'image-ai-paper-collage', 'title': '글자 조각 콜라주 만들기', 'description': '원하는 문장을 입력해 종이 조각을 이어 붙인 아날로그 수작업 느낌의 콜라주 이미지를 만들어 보세요.', 'route': '/image-ai/paper-collage/', 'source': 'pages/sections/image-ai/paper-collage.md', 'type': 'static-prompt', 'section': 'image-ai', 'order': 47, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'ai-practice-fridge-recipe', 'title': '사진으로 레시피 찾기', 'description': 'AI가 사진을 보고, 사람이 확인하고, 대화를 이어가며 레시피를 완성합니다.', 'route': '/ai-practice/fridge-recipe/', 'source': 'pages/sections/ai-practice/fridge-recipe.md', 'type': 'static-prompt', 'section': 'ai-practice', 'order': 54, 'navigation': True, 'status': 'published', 'lang': 'ko'},
)
