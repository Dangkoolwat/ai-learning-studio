...
EXPECTED_PAGES = (
    ...
    {'id': 'ai-practice', 'title': '프롬프트 단계별 체험하기', 'description': '짧은 요청이 하나의 완성된 프롬프트로 발전하는 과정을 직접 체험해 보세요.', 'route': '/ai-practice/', 'source': 'pages/sections/ai-practice.md', 'type': 'static-prompt', 'section': 'ai-practice', 'order': 1, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'prompt-snippets-experience-to-asset', 'title': '경험을 나만의 자산으로 바꾸기 ⭐', 'description': '경험과 노하우를 연결해 강점을 찾고 반복 활용 가능한 자산으로 축적하기', 'route': '/prompt-snippets/experience-to-asset/', 'source': 'pages/sections/prompt-snippets/experience-to-asset.md', 'type': 'static-prompt', 'section': 'prompt-snippets', 'navigation': True, 'status': 'published', 'lang': 'ko', 'order': 26},
    {'id': 'ready-to-use', 'title': '바로 써보기', 'description': '준비된 프롬프트를 내 상황에 맞게 바꾸고 바로 활용해 보세요.', 'route': '/ready-to-use/', 'source': 'pages/sections/ready-to-use.md', 'type': 'static-prompt', 'section': 'ready-to-use', 'order': 26, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'ai-assistant', 'title': '나만의 AI 만들기', 'description': '프로젝트와 GPTs(GEM)를 활용해 작업별로 AI를 분리하고, 더 일관된 결과를 만들어 보세요.', 'route': '/ai-assistant/', 'source': 'pages/sections/ai-assistant.md', 'type': 'static-prompt', 'section': 'ai-assistant', 'order': 31, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'image-ai', 'title': '이미지 생성', 'description': '이미지 프롬프트의 특징을 이해하고 원하는 이미지를 더 정확하게 만들어 보세요.', 'route': '/image-ai/', 'source': 'pages/sections/image-ai.md', 'type': 'static-prompt', 'section': 'image-ai', 'order': 41, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    ...
    {'id': 'image-ai-sketch-sticker', 'title': '사진 속 인물만 손그림 스티커로 바꾸기', 'description': '배경 사진은 그대로 두고, 사진 속 인물만 흰색 테두리가 있는 흑백 손그림 스티커처럼 바꿔보세요.', 'route': '/image-ai/sketch-sticker/', 'source': 'pages/sections/image-ai/sketch-sticker.md', 'type': 'static-prompt', 'section': 'image-ai', 'order': 56, 'navigation': True, 'status': 'published', 'lang': 'ko'},
    {'id': 'ai-practice-fridge-recipe', 'title': '사진으로 레시피 찾기', 'description': '냉장고 속 재료 사진을 기반으로 맞춤 레시피를 제안하고, 대화를 나누며 요리 가이드를 완성해 보세요.', 'route': '/ai-practice/fridge-recipe/', 'source': 'pages/sections/ai-practice/fridge-recipe.md', 'type': 'static-prompt', 'section': 'ai-practice', 'order': 57, 'navigation': True, 'status': 'published', 'lang': 'ko'},
)
