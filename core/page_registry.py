...
EXPECTED_PAGES = (
    {   'id': 'home',
        ...
        'description': 'AI 입문자와 기초 활용자가 프롬프트 복사, 요청 정리, 이미지 AI 실습을 차근차근 배우는 한국어 학습 '
                       '사이트',
        'route': '/',
    ...
    {   'id': 'ai-assistant-gemini-verifier',
        'title': 'Gemini 지식 검증',
        'description': 'Gemini GEMs 및 Projects 전용 지식 검증 전문가(Knowledge Verification '
                       'Expert) 지침 프롬프트입니다.',
    ...
    {   'id': 'ai-assistant-gemini-canvas-map',
        ...
        'description': 'Gemini Canvas를 활용해 웹 브라우저에서 바로 작동하는 단일 HTML Leaflet 대화형 여행 '
                       '지도를 만드는 프롬프트입니다.',
    ...
    {   'id': 'ai-assistant-self-development-coach',
        'title': '현실적인 자기계발 코치',
        'description': '목표를 실천 가능한 작은 단위로 나누고, 무리하지 않게 지속할 수 있도록 돕는 1:1 맞춤형 코치 시스템 '
                       '프롬프트입니다.',
    ...
    {   'id': 'ready-to-use-healing-chat',
        ...
        'description': '복잡한 마음을 털어놓고 싶을 때, 원하는 방식(위로, 정리, 해결책)에 맞춰 AI와 편안하게 대화할 수 '
                       '있는 프롬프트입니다.',
    ...
    {   'id': 'ready-to-use-event-budget-calculator',
        ...
        'description': '경조사 종류와 관계, 참석 여부, 경제적 상황을 입력하면 최신 국내 조사와 공식 자료를 확인해 적절한 '
                       '금액과 전달 방법을 추천합니다.',
