...
이 프로젝트는 **수강생이 강의를 쉽게 따라갈 수 있도록, 강사의 교육 철학과 설명 흐름을 자연스럽게 보조하는 실전형 학습 도구**를 목표로 합니다.
...
| 영역 | 설명 |
|------|------|
| 🧪 프롬프트 단계별 체험하기 | 짧은 요청이 하나의 완성된 프롬프트로 발전하는 과정을 직접 체험하는 단계형 실습 메뉴입니다. |
| 🥄 프롬프트 한 스푼 | 결과 품질을 높이는 실전 한 줄 프롬프트 모음집입니다. |
| ⚡ 바로 써보기 | 준비된 프롬프트를 내 상황에 맞게 바꾸고 즉시 활용하는 메뉴입니다. |
| 🤖 나만의 AI 만들기 | 작업별로 AI 지침을 분리하고 일관된 결과를 만드는 맞춤형 AI 도우미 메뉴입니다. |
| 🎨 이미지 만들기 | 이미지 프롬프트의 특징을 이해하고 고품질 이미지를 생성하는 프롬프트 허브입니다. |
