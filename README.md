...
| 영역 | 설명 |
|------|------|
| 🧪 AI 체험 실습 | 하나의 주제를 제로샷에서 시작해 프롬프트를 단계적으로 보강하며 최종본을 완성하는 체험형 메뉴입니다. |
| ⚡ 바로 사용하기 | 바로 복사해서 쓸 수 있는 완성형 프롬프트를 제공합니다. |
| 🤖 AI 도우미 | Project나 GEM 전용 지침서 프롬프트를 범용 템플릿 형태로 제공합니다. |
| 🎨 이미지 AI | 이미지 생성용 프롬프트 허브로, 상위에서는 개념과 차이를 설명하고 하위에서는 세부 유형으로 확장합니다. |
